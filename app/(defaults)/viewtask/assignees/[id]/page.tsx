...
const projectId = params.projectId; // or whatever your route param name is
const templateId = params.templateId;
    ...
    const fetchTasks = async () => {
        try {
            ...
            const filtered = data.filter(task => task.projectId === projectId);
            setTasks(filtered || []);
        } catch (err) {
    ...
    const fetchOwners = async () => {
      ...
      const fetchProjects = async () => {
        try {
            ...
            // Extract tasks from the project that matches current projectId
            const project = data.data.find(p => p._id === projectId);
            if (project && project.tasks) {
                setTasks(project.tasks);  // This will replace fetchTasks()
            }
        } catch (err) {
